...
public partial class GuideWindow {
    private static readonly GuidePage GuideCounters = new() {
        ...
        Body = new Lumina.Text.ReadOnly.ReadOnlySeString(
                ...
                .Append("The bottom number is the amount of glamour dresser slots you have saved by having these pieces stored as outfits instead of being loose inside the dresser.\n\n")
